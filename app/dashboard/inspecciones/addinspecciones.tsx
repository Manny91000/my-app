...
export function AddInspection({
    ...
    const onSubmit = async (data: InspeccionSchemaForm) => {
        try {
            ...
            const response = await fetch("/api/inspeccion/crear", {
                method: "POST",
                headers: {
            ...
            setIsOpen(false);
            console.log("Inspeccion agregada con éxito");
            toast({
                title: "Inspeccion Agregada",
                description: "La Inspeccion ha sido agregada correctamente",
            });
        ...
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Llenar para agregar una nueva Inspeccion
                    </DialogDescription>
                </DialogHeader>
