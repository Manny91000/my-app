...
export function ActualizarAlquiler({
    vehiculo,
    vehiculos,
    clientes,
    empleados
    ...
    const form = useForm<AlquilerSchemaForm>({
        ...
        defaultValues: {
            id: vehiculo.id,
            employeeId: vehiculo.employeeId, vehicleId: vehiculo.id, customerId: vehiculo.customerId,
            rentDate: vehiculo.rentDate, returnDate: vehiculo.returnDate, dailyRate: vehiculo.dailyRate,
            days: vehiculo.days, comments: vehiculo.comments!, status: vehiculo.status,
        },
    });
    ...
    const onSubmit = async (data: AlquilerSchemaForm) => {
        try {
            ...
            const response = await fetch("/api/alquiler/actualizar", {
                method: "PUT",
                headers: {
            ...
            toast({
                ...
                description: "El Alquiler ha sido actualizado correctamente",
            });
            ...
            toast({
                variant: 'destructive',
                title: "Error al actualizar Alquiler",
    ...
    return (
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent className="sm:max-w-[425px] md:max-w-[825px]">
                <DialogHeader>
                    <DialogTitle>Actualizar Alquiler</DialogTitle>
                    <DialogDescription>
                        Llenar para actualizar este Alquiler
                    </DialogDescription>
                </DialogHeader>
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
                        ...
                        <Button type="submit">
                            {isLoading ? <Loader className='mr-2 h-4 w-4 animate-spin' /> : 'Actualizar Alquiler'}
                        </Button>
                    </form>
                </Form>
            </DialogContent>
